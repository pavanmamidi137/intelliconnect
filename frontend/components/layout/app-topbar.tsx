  ...
  return (
    <header className="sticky top-0 z-40 flex h-16 items-center gap-3 bg-background/40 px-4 backdrop-blur-xl sm:px-6">
      <button
        type="button"
        onClick={onMenuClick}
        className="inline-flex h-9 w-9 items-center justify-center rounded-md text-muted-foreground hover:bg-accent/60 hover:text-foreground lg:hidden"
      ...
      <div className="ml-auto flex items-center gap-1.5">
        <Button variant="ghost" size="icon" className="relative text-muted-foreground hover:text-foreground" aria-label="Notifications">
          ...
          <span className="absolute right-2 top-2 h-2 w-2 animate-pulse rounded-full bg-primary ring-2 ring-background" aria-hidden="true" />
        </Button>
