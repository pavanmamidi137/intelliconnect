...
# ---------------------------------------------------------------------------
# Transactional email (login OTP codes, password resets).
# SMTP credentials are read from the environment; without them, codes are
# logged and returned in dev mode so the flow still works locally.
# ---------------------------------------------------------------------------
